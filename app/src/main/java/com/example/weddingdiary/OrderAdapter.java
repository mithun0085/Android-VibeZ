...
public class OrderAdapter extends RecyclerView.Adapter<OrderAdapter.ViewHolder> {
    ...
    public OrderAdapter(Context context, List<Model2> modelList) {
    ...
    public void onBindViewHolder( ViewHolder holder, int position) {
        ...
        String nameofPackage = modelList.get(position).getmPackageName();
        String descriptionofpackage = modelList.get(position).getmPackageDetail();
        int images = modelList.get(position).getmPackagePhoto();

        holder.mPackageName.setText(nameofPackage);
        holder.mPackageDescription.setText(descriptionofpackage);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ViewHolder(View itemView) {
            ...
            mPackageDescription = itemView.findViewById(R.id.description);
